function Survey(survey) {
    ...
    function checkRequirements() {
      ...
      if (!formData[index].hasOwnProperty("answer") && +index === 5) {
        checkMemory(question5Memory);
        checkProud(question5Proud);
        checkGrateful(question5Grateful);
        ...
        if (arr.includes("memory")) checkMemory(question5Memory);
        if (arr.includes("proud")) checkProud(question5Proud);
        if (arr.includes("grateful")) checkGrateful(question5Grateful);
        if (
          arr.length === 4 &&
